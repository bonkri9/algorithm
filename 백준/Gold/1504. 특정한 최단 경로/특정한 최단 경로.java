...
//		System.out.println(Arrays.toString(dist));
	...
	public static void main(String[] args) throws IOException {
		...
		if(from1toV1 == INF || fromV1toV2 == INF || fromV2toN == INF) {
			ans1 = -1;
		}else {
			ans1 = from1toV1 + fromV1toV2 + fromV2toN;
		}
		
		if(from1toV2 == INF || fromV2toV1 == INF || fromV1toN == INF) {
			ans2 = -1;
		}else {
			ans2 = from1toV2 + fromV2toV1 + fromV1toN;
		}
